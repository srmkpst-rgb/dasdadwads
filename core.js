...
export const PLAYER = {
  ...
  DRIBBLE_GAP: 6            // extra gap beyond touching, ball rests this far off the body while carried
};

export const POSSESS = {
  LOCK_MS: 220              // grace period after winning the ball before an opponent can tackle it away
};
...
// Players per side for each selectable match size. Quick Match is always
// 1v1; the other sizes are opt-in via a room code since matching several
// strangers into the same lobby at once isn't something this game does.
export const MODES = { '1v1': 1, '2v2': 2, '3v3': 3, '4v4': 4, '5v5': 5, '6v6': 6 };
export const DEFAULT_MODE = '1v1';
...
// Kick-off spawn positions, mirrored per team. Index 0 is always the lone
// 1v1 spot; higher indices fan further-placed players out for 3v3..6v6.
